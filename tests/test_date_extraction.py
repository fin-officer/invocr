...
from invocr.formats.pdf.extractor import extract_date, parse_date
...
class TestDateExtraction(unittest.TestCase):
    ...
    def test_parse_date_relative(self):
        ...
        # Test with string days (should be handled by extract_date)
        self.assertEqual(
            parse_date("30", reference_date=ref_date, is_relative=True),
            "2023-11-14",  # 30 days after Oct 15
        )
    ...
    def test_extract_due_date_relative(self):
        ...
        """
        self.assertEqual(
            extract_date(text, "due"), "2023-11-14"
        )  # 30 days after Oct 15
    ...
    def test_extract_due_date_without_issue_date(self):
        ...
        self.assertEqual(extract_date("Due Date: 2023-11-15", "due"), "2023-11-15")
